...
// TODO
    function addToAlbum($link) {
      self.album.push({
        ...
        is_liked: $link.attr('data-is-liked') === 'true',
        is_favorited: $link.attr('data-is-favorited') === 'true',
        is_flagged: $link.attr('data-is-flagged') === 'true',
  ...
  Lightbox.prototype.updateDetails = function() {
    ...
    this.album[this.currentImageIndex].like_btn_func !== '') {
      ...
      console.log(`is_liked for currentImageIndex: ${this.album[this.currentImageIndex].is_liked}, and containsSelected: ${containsSelected}`);
    ...
    if (typeof this.album[this.currentImageIndex].flag_btn_func !== 'undefined' &&
      ...
      let flag_button_iElement = $($flagbutton[0]).children("i")[0];
      let containsSelected = flag_button_iElement.classList.contains('selected');

      if (this.album[this.currentImageIndex].is_flagged && containsSelected == false) {
        $(flag_button_iElement).addClass('selected');
      }

      if (this.album[this.currentImageIndex].is_flagged == false && containsSelected == true) {
        $(flag_button_iElement).removeClass('selected');
      }
